...
HD_PWD='E:/program/cpu/PLCPU_FPGA/PLCPU_FPGA/PLCPU_FPGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PLCPUSOC_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PLCPUSOC_Top.tcl
