...
HD_PWD='E:/program/cpu/PLCPU_FPGA/PLCPU_FPGA/PLCPU_FPGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PLCPUSOC_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PLCPUSOC_Top.tcl -notrace
