...
#
# Generated by export_simulation on Tue May 20 18:54:58 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './imem.sh' script.
...
./imem.sh -noclean_files

For more information on the script, please type './imem.sh -help'.
