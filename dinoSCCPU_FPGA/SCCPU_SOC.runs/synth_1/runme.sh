...
HD_PWD='E:/program/cpu/SCCPU_FPGA/SCCPU_SOC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RVSCCPUSOC_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RVSCCPUSOC_Top.tcl
