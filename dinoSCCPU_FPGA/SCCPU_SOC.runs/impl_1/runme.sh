...
HD_PWD='E:/program/cpu/SCCPU_FPGA/SCCPU_SOC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RVSCCPUSOC_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RVSCCPUSOC_Top.tcl -notrace
